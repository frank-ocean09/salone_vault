            ...
            <main className="max-w-4xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
                ...
                <div className="bg-gray-50 rounded-[2.5rem] p-8 sm:p-12 border border-gray-100 shadow-xl">
                    <div className="flex items-center gap-4 mb-12">
                        ...
                        <div>
                            <h1 className="text-3xl font-black text-[#02353C] tracking-tight">Privacy Policy</h1>
                            <p className="text-[#02353C]/40 font-bold text-sm uppercase tracking-widest">Effective Date: January 2026</p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-12 text-[#02353C]/80 leading-relaxed">
                        ...
                        <section>
                            ...
                            <ul className="space-y-4">
                                <li className="flex gap-3">
                                    ...
                                    <p><strong className="text-[#02353C]">Personal Data:</strong> Name, email, and other contact details provided by you.</p>
                                </li>
                                <li className="flex gap-3">
                                    <div className="h-2 w-2 rounded-full bg-[#3FD0C9] mt-2 shrink-0" />
                                    <p><strong className="text-[#02353C]">Document Data:</strong> Uploaded documents and related metadata (e.g., type, upload date, folder name).</p>
                                </li>
                                <li className="flex gap-3">
                                    <div className="h-2 w-2 rounded-full bg-[#3FD0C9] mt-2 shrink-0" />
                                    <p><strong className="text-[#02353C]">System Data:</strong> Account activity logs, login records, and permission changes.</p>
                                </li>
                            </ul>
                        </section>
                        ...
                        <section>
                            ...
                            <ul className="space-y-6">
                                ...
                                <li className="p-6 bg-[#3FD0C9]/5 rounded-2xl border border-[#3FD0C9]/20">
                                    <p className="font-bold text-[#02353C] mb-2 font-heading uppercase text-xs tracking-widest">Activity Audit Logs</p>
                                    <p className="text-sm">
                        ...
                        <section className="pt-8 border-t border-gray-100">
                            ...
                            <div className="flex items-center gap-4 p-6 bg-white rounded-2xl border border-gray-100">
                                ...
                                <div>
                                    <p className="text-xs font-black uppercase tracking-widest text-[#02353C]/40 mb-1">Email Support</p>
