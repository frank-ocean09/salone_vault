...
export function Navbar() {
    ...
    return (
        <nav className={`bg-white border-b border-[#02353C]/5 sticky top-0 z-50 transform transition-all duration-500 shadow-xl ${hidden && !isOpen ? '-translate-y-full' : 'translate-y-0'}`}>
                ...
                <div className="flex justify-between h-20">
                    <div className="flex items-center">
                        <Link to="/" className="flex items-center gap-3">
                            ...
                            <span className="font-black text-2xl text-[#02353C] tracking-tighter">
                                SALONEVAULT
                            </span>
                        </Link>
                    </div>
                        ...
                        {user ? (
                            <>
                                ...
                                <button
                                    ...
                                    className="flex items-center gap-2 text-[#02353C]/40 hover:text-red-500 transition-colors font-black text-[10px] uppercase tracking-[0.2em]"
                                >
                    ...
                    <div className="flex items-center md:hidden">
                        <button
                            ...
                            className="text-[#02353C] p-2 hover:bg-black/5 rounded-xl transition-colors"
                        >
            ...
            {
                isOpen && (
                    <div className="md:hidden bg-white border-b border-[#02353C]/5 animate-in fade-in slide-in-from-top-4 duration-300">
                        <div className="px-4 pt-2 pb-6 space-y-2">
                            <Link
                                to="/"
                                className="block px-3 py-4 rounded-xl text-xs font-black uppercase tracking-widest text-[#02353C]/60 hover:text-[#02353C] hover:bg-black/5 transition-all"
                            ...
                            {user ? (
                                <div className="space-y-2 pt-4 border-t border-black/5">
                                    ...
                                    <button
                                        ...
                                        className="w-full text-left px-3 py-4 rounded-xl text-xs font-black uppercase tracking-widest text-[#02353C]/40 hover:text-[#02353C] transition-all flex items-center gap-2"
                                    >
                                        <LogOut className="h-4 w-4" />
                                        Sign Out
                                    </button>
